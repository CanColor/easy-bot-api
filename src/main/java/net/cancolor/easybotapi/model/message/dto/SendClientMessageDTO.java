...
import net.cancolor.easybotapi.model.message.role.Bot;
import net.cancolor.easybotapi.model.message.role.Friend;
import net.cancolor.easybotapi.model.message.role.Group;
