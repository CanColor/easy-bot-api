...
import net.cancolor.easybotapi.model.message.MusicShareMessage;
import net.cancolor.easybotapi.model.message.PokeMessage;
import net.cancolor.easybotapi.model.message.UrlMessage;
